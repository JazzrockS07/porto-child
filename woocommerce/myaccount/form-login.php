...
<div class="featured-box align-left porto-user-box">
	<div class="box-content">
		...
		<?php endif; ?>
				...
				<h2><?php esc_html_e( 'כניסה - ללקוחות עם חשבון קיים', 'porto' ); ?></h2>
		...
		<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
			...
			<div class="u-column2 col-2">
				...
				<h2><?php esc_html_e( 'הרשמה - ללקוחות חדשים', 'porto' ); ?></h2>
				...
				<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
					...
					<?php else : ?>
						...
						<p><?php esc_html_e( 'סיסמה תישלח לכתובת המייל שלך.', 'woocommerce' ); ?></p>
