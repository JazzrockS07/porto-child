...
<div class="woocommerce-order woocommerce-thankyou col-lg-8 mx-auto px-0">
	...
	if ( $order ) :
		...
		<?php else : ?>
			...
			<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received line-height-md text-center text-v-dark"><i class="fas fa-check me-2"></i><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'לקוח טויויה יקר, תודה על הזמנתך, עם קליטת ההזמנה במערכת תקבל אוטומטית אימל לתיבה שהזנת. במידה ולא קיבלת אימל, אנא בדוק את תיבת הספאם או צור קשר עם השירות לקוחות של שלנו. לאחר שהזמנתך תישלח ותגיע למרכז חלוקה קרוב לכתובת למשלוח שהזנת, תקבל הודעת טקסט לטלפון הנייד עם פרטים לאיסוף ומעקב.', 'woocommerce' ), $order ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				<br>
				<br>
				<?php echo esc_html__('אנחנו כאן תמיד בשבילך, צוות טיויה.', 'woocommerce'); ?>
			</p>
